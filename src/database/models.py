...
class PostInGroupType(Base):
    ...
    post_in_group_type_id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
...
class Group(Base):
    ...
    specialization_id: Mapped[int] = mapped_column(
        ForeignKey("specialization.specialization_id", onupdate="CASCADE", ondelete="CASCADE")
    )
    qualification_id: Mapped[int] = mapped_column(
        ForeignKey("qualification.qualification_id", onupdate="CASCADE", ondelete="CASCADE")
    )
...
class ParentIndividualWork(Base):
    ...
    parent_individual_work_id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
...
class StudentIndividualWork(Base):
    ...
    student_individual_work_id: Mapped[int] = mapped_column(primary_key=True, autoincrement=True)
    student_id: Mapped[int] = mapped_column(ForeignKey("student.person_id"))
    date: Mapped[date] = mapped_column(Date)
    topic: Mapped[str] = mapped_column(Text)
    result: Mapped[str] = mapped_column(Text)
