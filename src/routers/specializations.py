...
def manage_specializations():
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if action == "delete":
                ...
                spec = (
                    ...
                    .filter(Specialization.specialization_id == spec_id)
                    .first()
                )
            ...
            if action in ("add", "edit"):
                ...
                if action == "edit":
                    ...
                    new_spec = Specialization(
                        specialization_name=name, specialization_reduction=reduction
                    )
        ...
        if edit_id:
            ...
            edit_item = (
                db.query(Specialization)
                .filter(Specialization.specialization_id == int(edit_id))
                .first()
            )
