...
student_parents_bp = Blueprint('student_parents', __name__, url_prefix='/admin/student-parents')
    ...
    try:
        ...
        for link in links:
            ...
            if student and parent:
                ...
                table_data.append({'student_id': link.student_id, 'parent_id': link.parent_id, 's_name': s_name, 'p_name': p_name})

        return render_template('admin_student_parents.html', title="Родители студентов", table_data=table_data, students=students, parents=parents)
    finally:
        db.close()