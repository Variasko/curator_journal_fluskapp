...
def manage_qualifications():
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if action == "delete":
                ...
                qual = (
                    ...
                    .filter(Qualification.qualification_id == qual_id)
                    .first()
                )
            ...
            if action in ("add", "edit"):
                ...
                if action == "edit":
                    ...
                    new_qual = Qualification(
                        qualification_name=name, qualification_reduction=reduction
                    )
        ...
        if edit_id:
            ...
            edit_item = (
                db.query(Qualification)
                .filter(Qualification.qualification_id == int(edit_id))
                .first()
            )

        return render_template(
            "admin_qualifications.html",
            title="Квалификации",
            items=items,
            edit_item=edit_item,
        )
