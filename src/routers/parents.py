...
def manage_parents():
    ...
    try:
            ...
            if action in ("add", "edit"):
                ...
                if action == "edit":
                    ...
                    if parent:
                        ...
                        parent.surname, parent.name, parent.patronymic, parent.phone = (
                            surname,
                            name,
                            patronymic or None,
                            phone or None,
        ...
        if request.args.get("edit"):
            ...
            edit_item = db.query(Parent).get(int(request.args.get("edit")))

        return render_template(
            "admin_parents.html", title="Родители", items=items, edit_item=edit_item
        )
