...
statuses_bp = Blueprint(
    "social_statuses", __name__, url_prefix="/admin/social-statuses"
)
...
def manage_social_statuses():
    ...
    try:
        ...
        if request.args.get("edit"):
            ...
            edit_item = db.query(SocialStatus).get(int(request.args.get("edit")))

        return render_template(
            "admin_social_statuses.html",
